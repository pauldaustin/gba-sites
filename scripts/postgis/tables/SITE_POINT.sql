CREATE TABLE  GBA.SITE_POINT
(
	SITE_ID NUMERIC(10) NOT NULL,
	PARENT_SITE_ID NUMERIC(10),
  EMERGENCY_MANAGEMENT_SITE_IND VARCHAR(1) NOT NULL,
	FULL_ADDRESS VARCHAR(1000) NOT NULL,
  CUSTODIAN_FULL_ADDRESS VARCHAR(1000),
  POSTAL_CODE VARCHAR(7),
	SITE_TYPE_CODE VARCHAR(7),
	SITE_LOCATION_CODE VARCHAR(1) NOT NULL,
	LOCALITY_ID NUMERIC(10) NOT NULL,
	REGIONAL_DISTRICT_ID VARCHAR(5) NOT NULL,
	COMMUNITY_ID NUMERIC(10),
	UNIT_DESCRIPTOR VARCHAR(1000),
	CIVIC_NUMBER NUMERIC(10),
	CIVIC_NUMBER_SUFFIX VARCHAR(10),
	CIVIC_NUMBER_RANGE VARCHAR(50),
  STREET_NAME_ID NUMERIC(10),
  STREET_NAME VARCHAR(100),
	STREET_NAME_ALIAS_1_ID NUMERIC(10),
	ADDRESS_COMMENT VARCHAR(4000),
	USE_IN_ADDRESS_RANGE_IND VARCHAR(1) NOT NULL,
  TRANSPORT_LINE_ID NUMERIC(10),
	FEATURE_STATUS_CODE VARCHAR(1) NOT NULL,
	USE_SITE_NAME_IN_ADDRESS_IND VARCHAR(1) NOT NULL,
	SITE_NAME_1 VARCHAR(100),
	SITE_NAME_2 VARCHAR(100),
	SITE_NAME_3 VARCHAR(100),
	CREATE_PARTNER_ORG_ID NUMERIC(10) NOT NULL,
	MODIFY_PARTNER_ORG_ID NUMERIC(10) NOT NULL,
	CUSTODIAN_PARTNER_ORG_ID NUMERIC(10),
  CUSTODIAN_SITE_ID VARCHAR(36),
	OPEN_DATA_IND VARCHAR(1) NOT NULL,
	CAPTURE_DATE TIMESTAMP(6),
	EXTENDED_DATA VARCHAR(4000),
	EXCLUDED_RULES VARCHAR(4000),
	DATA_CAPTURE_METHOD_CODE VARCHAR(30) NOT NULL,
	CREATE_INTEGRATION_SESSION_ID NUMERIC(10) NOT NULL,
	MODIFY_INTEGRATION_SESSION_ID NUMERIC(10) NOT NULL,
  CUSTODIAN_SESSION_ID NUMERIC(10),
  GEOMETRY geometry(MULTIPOINT,3005) NOT NULL,
	CONSTRAINT GBA_SP_PK PRIMARY KEY (SITE_ID),
	CONSTRAINT GBA_SP_C_GBA_ISP_FK FOREIGN KEY (CREATE_INTEGRATION_SESSION_ID) REFERENCES  GBA.INTEGRATION_SESSION_POLY (INTEGRATION_SESSION_POLY_ID),
	CONSTRAINT GBA_SP_M_GBA_ISP_FK FOREIGN KEY (MODIFY_INTEGRATION_SESSION_ID) REFERENCES  GBA.INTEGRATION_SESSION_POLY (INTEGRATION_SESSION_POLY_ID),
	CONSTRAINT GBA_SP_GBA_DCMC_FK FOREIGN KEY (DATA_CAPTURE_METHOD_CODE) REFERENCES  GBA.DATA_CAPTURE_METHOD_CODE (DATA_CAPTURE_METHOD_CODE),
	CONSTRAINT GBA_SP_GBA_FSC_FK FOREIGN KEY (FEATURE_STATUS_CODE) REFERENCES  GBA.FEATURE_STATUS_CODE (FEATURE_STATUS_CODE),
	CONSTRAINT GBA_SP_C_GBA_PO_FK FOREIGN KEY (CREATE_PARTNER_ORG_ID) REFERENCES  GBA.PARTNER_ORGANIZATION (PARTNER_ORGANIZATION_ID),
	CONSTRAINT GBA_SP_M_GBA_PO_FK FOREIGN KEY (MODIFY_PARTNER_ORG_ID) REFERENCES  GBA.PARTNER_ORGANIZATION (PARTNER_ORGANIZATION_ID),
	CONSTRAINT GBA_SP_U_GBA_PO_FK FOREIGN KEY (CUSTODIAN_PARTNER_ORG_ID) REFERENCES  GBA.PARTNER_ORGANIZATION (PARTNER_ORGANIZATION_ID),
	CONSTRAINT GBA_SP_GBA_SLC_FK FOREIGN KEY (SITE_LOCATION_CODE) REFERENCES  GBA.SITE_LOCATION_CODE (SITE_LOCATION_CODE),
	CONSTRAINT GBA_SP_GBA_STC_FK FOREIGN KEY (SITE_TYPE_CODE) REFERENCES  GBA.SITE_TYPE_CODE (SITE_TYPE_CODE),
	CONSTRAINT GBA_SP_GBA_SN_FK FOREIGN KEY (STREET_NAME_ID) REFERENCES  GBA.STRUCTURED_NAME (STRUCTURED_NAME_ID),
	CONSTRAINT GBA_SP_1_GBA_SN_FK FOREIGN KEY (STREET_NAME_ALIAS_1_ID) REFERENCES  GBA.STRUCTURED_NAME (STRUCTURED_NAME_ID),
	CONSTRAINT GBA_SP_GBA_TL_FK FOREIGN KEY (TRANSPORT_LINE_ID) REFERENCES  GBA.TRANSPORT_LINE (TRANSPORT_LINE_ID),
	CONSTRAINT GBA_SP_GBA_CP_FK FOREIGN KEY (COMMUNITY_ID) REFERENCES  GBA.COMMUNITY_POLY (COMMUNITY_ID),
	CONSTRAINT GBA_SP_U_GBA_ISP_FK FOREIGN KEY (CUSTODIAN_SESSION_ID) REFERENCES  GBA.INTEGRATION_SESSION_POLY (INTEGRATION_SESSION_POLY_ID),
	CONSTRAINT GBA_SP_GBA_LP_FK FOREIGN KEY (LOCALITY_ID) REFERENCES  GBA.LOCALITY_POLY (LOCALITY_ID),
	CONSTRAINT GBA_SP_GBA_RDP_FK FOREIGN KEY (REGIONAL_DISTRICT_ID) REFERENCES  GBA.REGIONAL_DISTRICT_POLY (REGIONAL_DISTRICT_ID)
)
;

ALTER TABLE GBA.SITE_POINT ADD CONSTRAINT GBA_SP_GBA_SP_FK FOREIGN KEY (PARENT_SITE_ID) REFERENCES  GBA.SITE_POINT (SITE_ID);

CREATE INDEX GBA_SP_C_GBA_ISP_FK_I
 ON GBA.SITE_POINT (CREATE_INTEGRATION_SESSION_ID) 

;
CREATE INDEX GBA_SP_M_GBA_ISP_FK_I
 ON GBA.SITE_POINT (MODIFY_INTEGRATION_SESSION_ID) 
...
CREATE SEQUENCE SITE_POINT_SITE_ID_SEQ 
	INCREMENT BY 1 
	START WITH 1 
	NO MAXVALUE 
	MINVALUE  1 
...
GRANT SELECT ON SITE_POINT_SITE_ID_SEQ TO GBA_USER
;

GRANT DELETE,INSERT,SELECT,UPDATE ON GBA.SITE_POINT TO gba_user
;

GRANT SELECT ON GBA.SITE_POINT TO gba_viewer
;
