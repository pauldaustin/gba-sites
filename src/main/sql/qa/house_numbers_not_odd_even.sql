...
where
  t.left_locality_id  is not null and (
    (upper(left_house_num_scheme_code) = 'O' and (from_left_house_number % 2 = 0 or to_left_house_number % 2 = 0)) or
    (upper(right_house_num_scheme_code) = 'O' and (from_right_house_number % 2 = 0 or to_right_house_number % 2 = 0)) or
    (upper(left_house_num_scheme_code) = 'E' and (from_left_house_number % 2 = 1 or to_left_house_number % 2 = 1)) or
    (upper(right_house_num_scheme_code) = 'E' and (from_right_house_number % 2 = 1 or to_right_house_number % 2 = 1))
  )
order by
  locality_name,
  full_name,
